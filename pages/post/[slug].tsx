    ...
    <main>
      ...
      {submitted ? (
        <div className='flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto'>
          ...
          <p>Once it has beem approved, it will below</p>
        </div>
      ) : (
      <form action="" onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-5 max-w-2xl mx-auto mb-10'>
        ...
        <input type="submit" className='shadow bg-yellow-500 hover:bg-yellow-400 focus:shadow-outline text-white font-bold py-2 px-4 cursor-pointer rounded' />
      </form>
      )}
